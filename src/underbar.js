(function() {
  ...
  _.extend = function(obj) {
    ...
    _.each(objectsToAdd, function(objectAdd) {
      for (var key in objectAdd) {
        obj[key] = objectAdd[key];
      }
    });
    return obj;
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (store[string]) {
        ...
        return store[string] = func.apply(this, arguments);
      }
    };
  };
